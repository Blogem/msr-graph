...
- **Provenance & validation** *(established by P3.5; binds every chunk that writes facts or
  ...
  `Activity` with agent + version + time); measurements keep `dataLocator` + `citedIn`.
