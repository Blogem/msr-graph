...
// design.md), package-local per the convention that guard already follows
// (a comment there notes later chunks needing a live GraphDB for their own
// integration tests may promote it to a shared internal/testutil package
// rather than duplicating it -- this file is exactly such a duplication,
// done because internal/proposal cannot import internal/graph's test-only
