# document-manifest Specification

## Purpose

Define pure, offline parsing of the msr-archive `README.md` table into structured document records (title, report number, date, OCR sidecar path), and establish the parsed manifest as the single source of curated document metadata and OCR sidecar resolution.
