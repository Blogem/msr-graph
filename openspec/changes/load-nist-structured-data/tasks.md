...
- [ ] 2.2 Implement canonicalization: byte-wise ascending component sort, lockstep composition reorder, one-decimal mole-% formatting → canonical string (`BeF2-LiF | 66.0-34.0`)
